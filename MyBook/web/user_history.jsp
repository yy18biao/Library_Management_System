...
<%
    ...
    if (list == null) {
        request.getRequestDispatcher("UserBookServlet?op=getAllHistoryBook").forward(request, response);
        return;
    }
%>
<body>
...
<div id="main">
    <form action="UserBookServlet?op=getAllHistoryBook" method="post">
        输入图书名称查询：
